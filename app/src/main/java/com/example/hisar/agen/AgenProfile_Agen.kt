...
import com.example.hisar.databinding.ActivityAgenProfileAgenBinding
...
class AgenProfile_Agen : AppCompatActivity() {
    private lateinit var binding: ActivityAgenProfileAgenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAgenProfileAgenBinding.inflate(layoutInflater)
                ...
                override fun onResponse(call: Call<Jamaah>, response: Response<Jamaah>) {
                    if (response.isSuccessful){
                        ...
                        if (res.data.size < 1){
                            ...
                            daftar.adapter = DaftarJamaahAdapter_Agen(res.data,2)
                            binding.load.visibility = View.GONE
