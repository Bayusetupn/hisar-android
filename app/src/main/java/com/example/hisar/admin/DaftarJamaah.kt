...
class DaftarJamaah : AppCompatActivity() {

    private lateinit var binding: ActivityDaftarJamaahBinding
    private lateinit var daftar:RecyclerView
    private lateinit var adapter: DaftarJamaahAdapter
            ...
            .enqueue(object : Callback<Jamaah>{
                override fun onResponse(call: Call<Jamaah>, response: Response<Jamaah>) {
                    if (response.isSuccessful){
                        ...
                        adapter = DaftarJamaahAdapter(res.data,res.data.size)
                        list = res.data
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDaftarJamaahBinding.inflate(layoutInflater)
